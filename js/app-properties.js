    ...
    if ($('#image_site').hasClass('lots')) {
        ...
        if (($('#image_site').contents()[0].baseURI).search("beach") >= 1) {
            ...
            data = JSON.parse(`
            {
                ...
                {"id": 19,  "area":"512.21", "status":"Disponible" ,"price": 418, "financ": "Hasta 60 MSI", "enganche": "10%", "type": "premium", "description": ""},
                ...
                {"id": 75,  "area":"567.86", "status":"Disponible" ,"price": 418, "financ": "Hasta 60 MSI", "enganche": "10%", "type": "premium", "description": ""},
                ...
                {"id": 155,  "area":"917.85", "status":"Vendido" ,"price": 418, "financ": "Hasta 60 MSI", "enganche": "10%", "type": "estandar", "description": ""},
